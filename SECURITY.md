...
- **Preferred:** open a [GitHub Security Advisory](https://github.com/nousergon/morning-signal/security/advisories/new). This keeps the discussion private until a fix ships.
